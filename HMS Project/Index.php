...
<body>
  <header>
    ...
    <h5 style="top: margine -5px;bottom: margine 3px;margin-bottom: 10px;margin-top: 5px;margin-left: 50px;" id="tagline">We believe in luxury</h5>
    
  </header>
  <nav>
    <ul class="container" id="bottom" style="padding-bottom: 0px;">
  ...
  <main>
    ...
    <nav class="homecontainer">
      <ul>
        <li>
          <h3><b>Our Hotel</b></h3>
        </li>
        <li><img src="royal-cottage.jpg" width="100%" height="100%"></li>
        <li>
          <h3><b>Our Cottages</b></h3>
        </li>
        <li><img src="Royal cottage.jpeg" width="100%" height="100%"></li>
        <li><img src="White_house.jpg" width="100%"></li>
        <li><img src="Wild_cottage.jpeg" width="100%"></li>
      </ul>
    </nav>
  </main>
  <footer>
